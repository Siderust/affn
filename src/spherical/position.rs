...
//! }
//!
//! let pos = Position::<WorldOrigin, WorldFrame, Meter>::new_unchecked(
//!     45.0 * DEG,  // polar
//!     30.0 * DEG,  // azimuth
//!     1.0 * M      // distance
//! );
    ...
    U: LengthUnit,
{
    ...
    ///
    /// The caller must ensure angles are within canonical ranges and distance is non-negative.
    /// Prefer [`Position::new_with_params`] when inputs may be out of range.
    ...
    U: LengthUnit,
{
    ...
    ///
    /// The caller must ensure angles are canonical and distance is non-negative.
    /// Frame-specific `new` constructors generated by `#[derive(ReferenceFrame)]`
...
mod tests {
    ...
    fn test_spherical_coord_creation() {
        // new_unchecked(polar, azimuth, distance)
